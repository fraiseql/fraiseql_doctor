...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('fk_query', postgresql.UUID(as_uuid=True), sa.ForeignKey('tb_query.pk_query', ondelete='CASCADE'), nullable=False),
        sa.Column('fk_endpoint', postgresql.UUID(as_uuid=True), sa.ForeignKey('tb_endpoint.pk_endpoint', ondelete='CASCADE'), nullable=False),
