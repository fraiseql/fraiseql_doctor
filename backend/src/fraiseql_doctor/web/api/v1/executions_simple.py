...
from fraiseql_doctor.web.schemas.execution import ExecutionListResponse
...
async def get_query_history(
    ...
    return ExecutionListResponse(
        executions=mock_executions, total=total_count, limit=limit, offset=offset
    )
...
async def toggle_favorite(execution_id: str):
    ...
    return {"id": execution_id, "favorite": True, "message": "Favorite status toggled"}
