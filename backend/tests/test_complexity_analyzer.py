...
class TestQueryComplexityAnalyzer:
    ...
    def test_complex_nested_query(self):
        ...
        assert metrics.complexity_level in [ComplexityLevel.MEDIUM, ComplexityLevel.HIGH, ComplexityLevel.VERY_HIGH]
        ...
        assert any(keyword in rec for rec in recommendations 
    ...
    def test_query_with_multiple_lists(self):
        ...
        has_list_recommendation = any("list" in r or "pagination" in r or "limit" in r for r in recommendations)
    ...
    def test_complexity_levels(self):
        ...
        assert complex_metrics.complexity_level in [
    ...
    def test_optimization_recommendations(self):
        ...
        assert any(keyword in recommendations_text for keyword in [
            "depth", "field", "pagination", "fragment", "limit"
        ])
    ...
    def test_optimization_suggestions(self):
        ...
        assert any(keyword in optimization_text for keyword in [
            "caching", "dataloader", "fragment", "depth"
        ])
