...
async def test_execution_manager():
    ...
    try:
        from src.fraiseql_doctor.core.execution_manager import (
            QueryExecutionManager, ExecutionConfig, ExecutionStatus, BatchMode
        )
...
async def test_query_collection_manager():
    ...
    complexity_analyzer.analyze_query = AsyncMock(return_value=MagicMock(
    ...
    try:
        collection_manager = QueryCollectionManager(mock_db_session, complexity_analyzer)
