...
class QueryCreate(BaseModel):
    ...
    expected_complexity_score: Optional[int] = Field(None, ge=0, description="Expected complexity score")
...
class QueryCollectionCreate(BaseModel):
    ...
    initial_queries: list[QueryCreate] = Field(default_factory=list, description="Initial queries to add")
